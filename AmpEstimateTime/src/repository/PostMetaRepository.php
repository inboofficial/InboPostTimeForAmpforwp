...
{
    public const INBO_COLOR_GUTENBERG_MATA_KEY_NAME = '_INBO_COLOR_GUTENBERG_MATA_KEY';
    ...
    {
        register_post_meta('post',  self::INBO_COLOR_GUTENBERG_MATA_KEY_NAME
            , array(
                'show_in_rest' => true,
                'single' => true,
                'type' => 'string',
    ...
    public function get_inbo_color_post_meta($post_id)
    {
        return get_post_meta($post_id, self::INBO_COLOR_GUTENBERG_MATA_KEY_NAME, true);
    }

    public function set_inbo_color_post_meta($post_id, $data)
    {
        $sanitized_data = sanitize_text_field($data);
        update_post_meta($post_id, self::INBO_COLOR_GUTENBERG_MATA_KEY_NAME, $sanitized_data);
    }
    ...
    public function uninstall(){
        delete_metadata( 'post', 0, self::INBO_COLOR_GUTENBERG_MATA_KEY_NAME, false, true );
